...
export async function buildWorkbook() {
  ...
  codebook.addRow({ col: 'PU / PS / HT / NA / CE', section: 'Model 2 — construct scores', text: 'Organism construct score per scenario = mean of that scenario\'s 3 organism items (organism + item3 + item4). PU=Perceived Urgency (E1), PS=Perceived Deal Smartness (E2), HT=Heuristic Price Trust (E5), NA=Negative Affect/Irritation (E6), CE=Perceived Cognitive Ease (E7). E3 (PP=Perceived Personalization/Ease) and E4 (PA=Positive Affect/Mood) were removed from the live flow on 2026-08-18 — earlier respondents\' answers to those two still exist in Scenarios_Long but no longer appear here.', scale: '1–5 (mean of 3 items)' });
  codebook.addRow({ col: 'II_composite', section: 'Model 2 — dependent variable', text: 'Impulse purchase intention composite = mean of all 5 current scenarios\' likelihood (item 1) ratings. Regress on PU/PS/HT/NA/CE per Fresh Start/model2-survey-spec.md (as amended after E3/E4 were dropped)', scale: '1–5 (mean of 5 items)' });
